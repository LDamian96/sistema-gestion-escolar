...
export default function StudentNotificacionesPage() {
  ...
  // Cargar notificaciones para STUDENT
  useEffect(() => {
    loadNotifications()
  }, [])
  ...
  const loadNotifications = async () => {
    try {
      setLoading(true)
      // Obtener notificaciones dirigidas a estudiantes o a todos
      const data = await notificationsService.getByRole('STUDENT')
